    ...
    const handlePublish = async () => {
        ...
        try {
            const { project: publishedProject } =
                await editorApi.publishProject(token, projectId);
            setProject({
            ...
            <header className="flex items-center justify-between gap-[12px]">
                ...
                <div className="inline-flex items-center gap-[6px]">
                    <button
                        ...
                        onClick={() =>
                            navigate(
                                `/editor/project/${resolvedProjectId}/settings`
                            )
                        }
            ...
            <section className="flex flex-col gap-[8px]">
                ...
                <div className="inline-flex items-center gap-[8px] text-[12px]">
                    ...
                    {projectIsPublic && (
                        ...
                        >
                            {t(
                                'projectHome.visibility.openCommunity',
                                'Open Community'
                            )}
                        </a>
                    )}
                    ...
                    >
                        ...
                        {projectIsPublic
                            ? t(
                                  'projectHome.visibility.published',
                    ...
                    >
                        ...
                        <span className="flex min-w-0 flex-col gap-[2px]">
                            ...
                            <span className="text-[11px] text-[var(--color-6)]">
                                {t(
                                    `projectHome.actions.${action.key}.description`
                                )}
                            </span>
                        </span>
                    </button>
