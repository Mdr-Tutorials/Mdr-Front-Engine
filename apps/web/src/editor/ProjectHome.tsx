    ...
    <div className="flex flex-col gap-[16px] p-[18px_20px] text-[var(--color-10)]">
      <header className="flex items-center justify-between gap-[12px]">
        <div className="flex flex-col gap-[4px]">
          ...
          <p className="m-0 text-[12px] text-[var(--color-6)]">{t('projectHome.subtitle')}</p>
        </div>
      ...
      <section className="flex flex-col gap-[8px]">
        <div className="inline-flex items-center gap-[8px] text-[12px]">
          <span className="text-[var(--color-6)]">{t('projectHome.fields.id')}</span>
          <span className="font-semibold font-mono text-[var(--color-9)]">{resolvedProjectId}</span>
        </div>
        <div className="inline-flex items-center gap-[8px] text-[12px]">
          <span className="text-[var(--color-6)]">{t('projectHome.fields.name')}</span>
          <span className="font-semibold font-mono text-[var(--color-9)]">{projectName}</span>
        </div>
      </section>
