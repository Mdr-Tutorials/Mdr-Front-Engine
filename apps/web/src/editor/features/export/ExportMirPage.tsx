...
export function ExportMirPage() {
  ...
  const activeDescription =
    activeTab === "mir"
      ...
      : t("react.description", { defaultValue: "基于当前 MIR 生成的 React 组件代码" })
  const activeEmpty =
    activeTab === "mir"
    ...
    <div className="ExportMirPage">
      <div className="ExportMirPageHeader">
        ...
        <div className="ExportMirPageActions">
          <div className="ExportMirPageTabs" role="tablist" aria-label={t("title", { defaultValue: "导出代码" })}>
            <button
              type="button"
      ...
      <div className="ExportMirPageBody">
        {activeCode ? (
          <CodeViewer code={activeCode} lang={activeTab === "mir" ? "json" : "typescript"} />
        ) : (
