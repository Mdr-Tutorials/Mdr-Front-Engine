                ...
                <InspectorRow
                    ...
                    control={
                        <input
                            ...
                            placeholder={t(
                                'inspector.fields.link.destinationPlaceholder',
                                {
                                    defaultValue:
                                        '/path or https://example.com',
                                }
                            )}
                        />
                    }
                ...
                <InspectorRow
                    ...
                    control={
                        <select
                            ...
                            onChange={(event) =>
                                onChangeTarget(
                                    event.target.value as '_self' | '_blank'
                                )
                            }
                        >
                ...
                <InspectorRow
                    ...
                    control={
                        <input
                            ...
                            value={rel}
                            onChange={(event) =>
                                onChangeRel(event.target.value)
                            }
                ...
                <InspectorRow
                    ...
                    control={
                        <input
                            ...
                            placeholder={t(
                                'inspector.fields.link.titlePlaceholder',
                                {
