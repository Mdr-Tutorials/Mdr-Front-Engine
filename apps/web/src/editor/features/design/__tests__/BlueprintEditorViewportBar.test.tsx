...
describe("BlueprintEditorViewportBar", () => {
  it("updates zoom, width, and height", () => {
    ...
    fireEvent.input(screen.getByTestId("mdr-slider"), { target: { value: "110" } })
  ...
  it("applies quick preset buttons", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: `${preset.width}×${preset.height}` }))
  ...
  it("applies device preset selections", () => {
    ...
    const deviceButtons = within(popover).getAllByRole("button", { name: /×/ })
