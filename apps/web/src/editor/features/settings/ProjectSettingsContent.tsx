        ...
        <div className="grid gap-4.5">
            ...
            >
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.description.description'
                    )}
                    control={
                        <MdrTextarea
                            size="Small"
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.defaultRoute.description'
                    )}
                    control={
                        <MdrInput
                            size="Small"
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.timezone.description'
                    )}
                    control={
                        <MdrSelect
                            size="Small"
                            options={[
                                {
                                    label: t(
                                        'settings.project.rows.timezone.options.utc'
                                    ),
                                    value: 'UTC',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.timezone.options.utcMinus5'
                                    ),
                                    value: 'UTC-5',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.timezone.options.utcPlus1'
                                    ),
                                    value: 'UTC+1',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.timezone.options.utcPlus8'
                                    ),
                                    value: 'UTC+8',
                                },
                            ]}
                            ...
                            onChange={(value) =>
                                updateProjectValue('timezone', value)
                            }
                        />
                    }
                />
            ...
            <SettingsPanel
                ...
                description={t(
                    'settings.project.panels.collaboration.description'
                )}
            >
                <SettingsRow
                    label={t('settings.project.rows.defaultRole.label')}
                    description={t(
                        'settings.project.rows.defaultRole.description'
                    )}
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.project.rows.defaultRole.options.viewer'
                                    ),
                                    value: 'viewer',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.defaultRole.options.editor'
                                    ),
                                    value: 'editor',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.defaultRole.options.admin'
                                    ),
                                    value: 'admin',
                                },
                            ]}
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.previewAccess.description'
                    )}
                    control={
                        <MdrRadioGroup
                            options={[
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.auditRetention.description'
                    )}
                    control={
                        <MdrSlider
                            min={7}
                            ...
                            onChange={(value) =>
                                updateProjectValue('auditRetention', value)
                            }
                            size="Small"
                        />
                    }
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.notifications.description'
                    )}
                    control={
                        <MdrCheckList
                            items={[
                            ...
                            onChange={(values) =>
                                updateProjectValue('notifications', values)
                            }
                        />
                    }
                />
            ...
            <SettingsPanel
                ...
                description={t(
                    'settings.project.panels.designSystem.description'
                )}
            >
                <SettingsRow
                    label={t('settings.project.rows.themeTokenSet.label')}
                    description={t(
                        'settings.project.rows.themeTokenSet.description'
                    )}
                    control={
                        <MdrSelect
                            size="Small"
                ...
                <SettingsRow
                    label={t(
                        'settings.project.rows.componentLibraryVersion.label'
                    )}
                    description={t(
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.assetHost.description'
                    )}
                    control={
                        <MdrInput
                            size="Small"
                            ...
                            onChange={(value) =>
                                updateProjectValue('assetHost', value)
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.fontPack.description'
                    )}
                    control={
                        <MdrCheckList
                            items={[
                            ...
                            onChange={(values) =>
                                updateProjectValue('fontPack', values)
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    control={
                        <MdrSelect
                            ...
                            onChange={(value) =>
                                updateProjectValue('iconSet', value)
                            }
                        />
                    }
                />
            ...
            <SettingsPanel
                ...
                description={t(
                    'settings.project.panels.integrations.description'
                )}
            >
                <SettingsRow
                    ...
                    control={
                        <MdrInput
                            ...
                            onChange={(value) =>
                                updateProjectValue('apiBase', value)
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.authMode.description'
                    )}
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.project.rows.authMode.options.oauth'
                                    ),
                                    value: 'oauth',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.authMode.options.apiKey'
                                    ),
                                    value: 'api-key',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.authMode.options.none'
                                    ),
                                    value: 'none',
                                },
                            ]}
                            ...
                            onChange={(value) =>
                                updateProjectValue('authMode', [value])
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.envPrefix.description'
                    )}
                    control={
                        <MdrInput
                            size="Small"
                            ...
                            onChange={(value) =>
                                updateProjectValue('envPrefix', value)
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.deploymentTarget.description'
                    )}
                    control={
                        <MdrRadioGroup
                            options={[
            ...
            >
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.schemaVersion.description'
                    )}
                    control={
                        <MdrSelect
                            size="Small"
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.strictness.description'
                    )}
                    control={
                        <MdrSlider
                            min={0}
                            ...
                            onChange={(value) =>
                                updateProjectValue('strictness', value)
                            }
                            size="Small"
                        />
                    }
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.customNodes.description'
                    )}
                    control={
                        <MdrCheckList
                            items={[
                                {
                                    label: t(
                                        'settings.project.rows.customNodes.options.http'
                                    ),
                                    value: 'http',
                                },
                                {
                                ...
                                {
                                    label: t(
                                        'settings.project.rows.customNodes.options.loop'
                                    ),
                                    value: 'loop',
                                },
                            ]}
                            ...
                            onChange={(values) =>
                                updateProjectValue('customNodes', values)
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.autoMigrate.description'
                    )}
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.project.rows.autoMigrate.options.enable'
                                    ),
                                    value: 'enabled',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.autoMigrate.options.disable'
                                    ),
                                    value: 'disabled',
                                },
                            ]}
            ...
            >
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.buildTarget.description'
                    )}
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.project.rows.buildTarget.options.web'
                                    ),
                                    value: 'web',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.buildTarget.options.mobile'
                                    ),
                                    value: 'mobile',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.buildTarget.options.desktop'
                                    ),
                                    value: 'desktop',
                                },
                            ]}
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.outputDir.description'
                    )}
                    control={
                        <MdrInput
                            size="Small"
                            ...
                            onChange={(value) =>
                                updateProjectValue('outputDir', value)
                            }
                        />
                    }
                />
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.project.rows.minify.options.enable'
                                    ),
                                    value: 'enabled',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.minify.options.disable'
                                    ),
                                    value: 'disabled',
                                },
                            ]}
                            ...
                            onChange={(value) =>
                                updateProjectValue('minify', [value])
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    description={t(
                        'settings.project.rows.sourceMaps.description'
                    )}
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.project.rows.sourceMaps.options.enable'
                                    ),
                                    value: 'enabled',
                                },
                                {
                                    label: t(
                                        'settings.project.rows.sourceMaps.options.disable'
                                    ),
                                    value: 'disabled',
                                },
                            ]}
