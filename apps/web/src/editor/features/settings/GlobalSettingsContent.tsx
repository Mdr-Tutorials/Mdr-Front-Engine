        ...
        <div className="grid gap-4.5">
            ...
            >
                    ...
                    control={
                        <MdrSelect
                            ...
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.language.options.en'
                                    ),
                                    value: 'en',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.language.options.zhCN'
                                    ),
                                    value: 'zh-CN',
                                },
                            ]}
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.theme.options.home'
                                    ),
                                    value: 'home',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.theme.options.light'
                                    ),
                                    value: 'light',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.theme.options.dark'
                                    ),
                                    value: 'dark',
                                },
                            ].map((option) => ({
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.density.options.comfortable'
                                    ),
                                    value: 'comfortable',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.density.options.compact'
                                    ),
                                    value: 'compact',
                                },
                            ].map((option) => ({
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.fontScale.description'
                    )}
            ...
            >
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.autosaveInterval.description'
                    )}
                    ...
                    control={
                        <MdrSlider
                            ...
                            onChange={(value) =>
                                updateValue('autosaveInterval', value)
                            }
                            size="Small"
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.undoSteps.description'
                    )}
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.confirmPrompts.description'
                    )}
                    ...
                    control={
                        <MdrCheckList
                            ...
                            onChange={(values) =>
                                updateValue('confirmPrompts', values)
                            }
                        />
                    }
                />
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.panelLayout.description'
                    )}
                    ...
                    control={
                        <MdrSelect
                            ...
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.panelLayout.options.balanced'
                                    ),
                                    value: 'balanced',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.panelLayout.options.focus'
                                    ),
                                    value: 'focus',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.panelLayout.options.wide'
                                    ),
                                    value: 'wide',
                                },
                            ]}
            ...
            >
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.viewportSize.description'
                    )}
                    ...
                    control={
                        <div className="inline-flex items-center gap-1.5">
                            <MdrInput
                                ...
                                onChange={(value) =>
                                    updateValue('viewportWidth', value)
                                }
                                disabled={!isOverrideEnabled('viewportWidth')}
                            />
                            <span className="text-[12px] text-(--color-6)">
                                ×
                            </span>
                            <MdrInput
                                size="Small"
                                ...
                                onChange={(value) =>
                                    updateValue('viewportHeight', value)
                                }
                        ...
                        <MdrCheckList
                            items={withDisabled(
                                [
                                    {
                                        label: t(
                                            'settings.global.rows.assist.options.grid'
                                        ),
                                        value: 'grid',
                                    },
                                    {
                                        label: t(
                                            'settings.global.rows.assist.options.alignment'
                                        ),
                                        value: 'align',
                                    },
                                    {
                                        label: t(
                                            'settings.global.rows.assist.options.snap'
                                        ),
                                        value: 'snap',
                                    },
                                ],
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.panInertia.description'
                    )}
            ...
            >
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.resolverOrder.description'
                    )}
                    ...
                    control={
                        <MdrSelect
                            ...
                            onChange={(value) =>
                                updateValue('resolverOrder', value)
                            }
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.customNamespaces.description'
                    )}
                    ...
                    control={
                        <MdrTextarea
                            ...
                            onChange={(value) =>
                                updateValue('customNamespaces', value)
                            }
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.renderMode.description'
                    )}
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.renderMode.options.strict'
                                    ),
                                    value: 'strict',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.renderMode.options.tolerant'
                                    ),
                                    value: 'tolerant',
                                },
                            ].map((option) => ({
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.externalProps.description'
                    )}
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.externalProps.options.allow'
                                    ),
                                    value: 'enabled',
                                },
                                {
                                ...
                                ...option,
                                disabled:
                                    !isOverrideEnabled('allowExternalProps'),
                            }))}
                            value={String(resolveValue('allowExternalProps'))}
                            onChange={(value) =>
                                updateValue('allowExternalProps', value)
                            }
                        />
                    }
                />
            ...
            >
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.defaultFramework.description'
                    )}
                    ...
                    control={
                        <MdrSelect
                            ...
                            options={[
                                ...
                                {
                                    label: t(
                                        'settings.global.rows.defaultFramework.options.vue'
                                    ),
                                    value: 'vue',
                                },
                                {
                            ...
                            onChange={(value) =>
                                updateValue('defaultFramework', value)
                            }
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.formatting.description'
                    )}
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.formatting.options.prettier'
                                    ),
                                    value: 'prettier',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.formatting.options.none'
                                    ),
                                    value: 'none',
                                },
                            ].map((option) => ({
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.outputPath.description'
                    )}
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.importStyle.description'
                    )}
                    ...
                    control={
                        <MdrSelect
                            ...
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.importStyle.options.auto'
                                    ),
                                    value: 'auto',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.importStyle.options.grouped'
                                    ),
                                    value: 'grouped',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.importStyle.options.single'
                                    ),
                                    value: 'single',
                                },
                            ]}
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.metadata.options.include'
                                    ),
                                    value: 'enabled',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.metadata.options.skip'
                                    ),
                                    value: 'disabled',
                                },
                            ].map((option) => ({
            ...
            >
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.shortcutPreset.description'
                    )}
                    ...
                    control={
                        <MdrSelect
                            ...
                            options={[
                                ...
                                {
                                    label: t(
                                        'settings.global.rows.shortcutPreset.options.vim'
                                    ),
                                    value: 'vim',
                                },
                                {
                            ...
                            onChange={(value) =>
                                updateValue('shortcutPreset', value)
                            }
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.diagnostics.description'
                    )}
                    ...
                    control={
                        <MdrCheckList
                            ...
                            onChange={(values) =>
                                updateValue('diagnostics', values)
                            }
                        />
                    }
                />
                    ...
                    control={
                        <MdrSelect
                            ...
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.logLevel.options.error'
                                    ),
                                    value: 'error',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.logLevel.options.warn'
                                    ),
                                    value: 'warn',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.logLevel.options.info'
                                    ),
                                    value: 'info',
                                },
                            ]}
                ...
                <SettingsRow
                    ...
                    description={t(
                        'settings.global.rows.telemetry.description'
                    )}
                    ...
                    control={
                        <MdrRadioGroup
                            options={[
                                {
                                    label: t(
                                        'settings.global.rows.telemetry.options.allow'
                                    ),
                                    value: 'on',
                                },
                                {
                                    label: t(
                                        'settings.global.rows.telemetry.options.disable'
                                    ),
                                    value: 'off',
                                },
                            ].map((option) => ({
