                ...
                <div className="absolute right-[14px] top-[48px] z-20 flex min-w-[170px] flex-col gap-[6px] rounded-[12px] border border-[var(--color-2)] bg-[var(--color-0)] p-[8px] shadow-[var(--shadow-lg)]">
                    {!project.isPublic ? (
                        <button
                            ...
                            disabled={
                                isPublishing || isDeleting || isClonedProject
                            }
                            title={
                                isClonedProject
                                    ? t(
                        ...
                        >
                            ...
                            {isClonedProject
                                ? t(
                                      'home.card.publishDisabled',
                                      'Publish disabled for copies'
                                  )
                                : isPublishing
                    ...
                    {!isLoading &&
                        sortedProjects.map((project) => (
                            <ProjectCard
                                ...
                                isPublishing={
                                    busyByProject[project.id] === 'publishing'
                                }
                                isDeleting={
                                    busyByProject[project.id] === 'deleting'
                                }
                            />
                        ))}
                </div>
