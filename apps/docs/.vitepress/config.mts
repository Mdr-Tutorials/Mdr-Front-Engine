    ...
    sidebar: {
      ...
      '/reference/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'MIR', link: '/reference/diagnostics/mir-1001' },
            { text: 'Workspace', link: '/reference/diagnostics/wks-1001' },
            { text: 'Editor', link: '/reference/diagnostics/edt-1001' },
            { text: 'API', link: '/reference/diagnostics/api-1001' },
            { text: 'External Library', link: '/reference/diagnostics/elib-1001' },
            { text: 'AI', link: '/reference/diagnostics/ai-1001' },
            { text: 'Codegen', link: '/reference/diagnostics/gen-1001' },
            { text: 'Route', link: '/reference/diagnostics/rte-1001' },
            { text: 'NodeGraph', link: '/reference/diagnostics/ngr-1001' },
            { text: 'Animation', link: '/reference/diagnostics/ani-1001' },
          ],
        },
      ],
      '/api/': [
