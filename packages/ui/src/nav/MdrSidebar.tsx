...
export interface MdrSidebarProps extends MdrComponent, MdrSidebarSpecificProps { }
...
function MdrSidebar({
    ...
    const fullClassName = `MdrSidebar ${collapsed ? 'Collapsed' : ''} ${className || ''}`.trim();
    const dataProps = { ...dataAttributes };

    return (
        <aside className={fullClassName} style={{ width, ...style as React.CSSProperties }} id={id} {...dataProps}>
