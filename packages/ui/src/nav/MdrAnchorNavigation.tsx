...
export interface MdrAnchorNavigationProps extends MdrComponent, MdrAnchorNavigationSpecificProps { }
...
function MdrAnchorNavigation({
    ...
    const fullClassName = `MdrAnchorNavigation ${orientation} ${className || ''}`.trim();
