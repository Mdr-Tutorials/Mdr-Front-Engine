    ...
    args: {
        ...
        children: (
            <div>
                ...
                <p>Please read this information carefully before proceeding with your action.</p>
    ...
    args: {
        ...
        children: (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div>
                    <label style={{ display: 'block', marginBottom: '4px' }}>Option 1</label>
                    <input type="checkbox" defaultChecked />
                </div>
                <div>
                    <label style={{ display: 'block', marginBottom: '4px' }}>Option 2</label>
                    <input type="checkbox" />
                </div>
                <div>
                    <label style={{ display: 'block', marginBottom: '4px' }}>Text Input</label>
                    <input type="text" placeholder="Enter value..." style={{ width: '100%', padding: '8px', border: '1px solid #ccc', borderRadius: '4px' }} />
                </div>
            </div>
        ),
        padding: 'Medium',
