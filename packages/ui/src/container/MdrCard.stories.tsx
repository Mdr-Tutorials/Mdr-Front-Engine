...
export const ProductCard: Story = {
    args: {
        children: (
            <div>
                <div style={{ height: '150px', backgroundColor: '#f0f0f0', borderRadius: '4px', marginBottom: '12px' }}></div>
                <h4>Product Name</h4>
                <p style={{ color: '#666', marginBottom: '8px' }}>Product description goes here</p>
    ...
    args: {
        children: (
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{ width: '60px', height: '60px', borderRadius: '50%', backgroundColor: '#e0e0e0', flexShrink: 0 }}></div>
                <div>
                    <h4 style={{ margin: '0 0 4px 0' }}>John Doe</h4>
                    <p style={{ margin: 0, color: '#666', fontSize: '14px' }}>Software Developer</p>
                </div>
            </div>
        ),
        variant: 'Bordered',
    ...
    render: () => (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            ...
            <MdrCard variant="Elevated" padding="Medium">
                ...
                <p style={{ margin: 0, fontSize: '32px', fontWeight: 'bold' }}>$45.6K</p>
            </MdrCard>
            <MdrCard variant="Elevated" padding="Medium">
