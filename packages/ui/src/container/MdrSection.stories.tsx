...
export const HeroSection: Story = {
    args: {
        children: (
            <div>
                <h1 style={{ fontSize: '48px', marginBottom: '16px' }}>Welcome to Our Platform</h1>
                <p style={{ fontSize: '20px', marginBottom: '24px' }}>Build amazing things with our components</p>
                <button style={{ padding: '12px 24px', fontSize: '16px', borderRadius: '6px', border: 'none', cursor: 'pointer' }}>
                    Get Started
                </button>
            </div>
        ),
