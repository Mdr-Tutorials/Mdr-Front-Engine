...
export interface MdrParagraphProps extends MdrComponent, MdrParagraphSpecificProps { }
...
function MdrParagraph({
    ...
    const fullClassName = `MdrParagraph ${size} ${weight} ${color} ${align} ${className || ''}`.trim();
