...
type IconRenderable = React.ReactElement<Record<string, any>> | React.ComponentType<any>;
...
export interface MdrIconProps extends Omit<MdrComponent, 'as'>, IconSpecificProps { }
