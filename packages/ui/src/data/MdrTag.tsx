...
function MdrTag({
    ...
    const fullClassName = `MdrTag ${size} ${color} ${variant} ${className || ''}`.trim();
    const dataProps = { ...dataAttributes };

    return (
        <span className={fullClassName} style={style as React.CSSProperties} id={id} onClick={onClick} {...dataProps}>
