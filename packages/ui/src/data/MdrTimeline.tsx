...
export interface MdrTimelineProps
    extends MdrComponent,
        MdrTimelineSpecificProps {}
        ...
        >
            {items.map((item, index) => (
                <div key={index} className="MdrTimelineItem">
                    <div
                        className={`MdrTimelineDot ${item.status || 'Default'}`}
                    />
                    <div className="MdrTimelineContent">
                        <div className="MdrTimelineTitle">{item.title}</div>
                        {item.time && (
                            <div className="MdrTimelineTime">{item.time}</div>
                        )}
                        {item.description && (
                            <div className="MdrTimelineDescription">
                                {item.description}
                            </div>
                        )}
                    </div>
