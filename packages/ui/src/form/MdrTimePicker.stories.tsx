...
export const States: Story = {
    render: () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '280px' }}>
            ...
            <MdrTimePicker label="Error" value="09:30" state="Error" message="Invalid time" />
            <MdrTimePicker label="Warning" value="09:30" state="Warning" message="Outside range" />
            <MdrTimePicker label="Success" value="09:30" state="Success" message="Available" />
        </div>
    ),
};
