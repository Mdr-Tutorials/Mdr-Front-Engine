...
export interface MdrRichTextEditorProps extends MdrComponent, MdrRichTextEditorSpecificProps { }
...
function MdrRichTextEditor({
    ...
    const fullClassName = `MdrRichTextEditor ${disabled ? 'Disabled' : ''} ${readOnly ? 'ReadOnly' : ''} ${className || ''}`.trim();
