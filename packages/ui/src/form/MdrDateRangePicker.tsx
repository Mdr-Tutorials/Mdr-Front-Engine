...
export interface MdrDateRangePickerProps extends MdrComponent, MdrDateRangePickerSpecificProps { }
...
function MdrDateRangePicker({
    ...
    const fullClassName = `MdrDateRangePicker ${size} ${state} ${disabled ? 'Disabled' : ''} ${readOnly ? 'ReadOnly' : ''} ${className || ''}`.trim();
