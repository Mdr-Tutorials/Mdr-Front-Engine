...
export const States: Story = {
    render: () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <MdrVerificationCode label="Error" length={6} state="Error" message="Invalid code" />
            <MdrVerificationCode label="Warning" length={6} state="Warning" message="Expiring soon" />
            <MdrVerificationCode label="Success" length={6} state="Success" message="Verified" />
        </div>
    ),
};
