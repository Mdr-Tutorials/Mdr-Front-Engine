...
export interface MdrRadioGroupProps
    extends MdrComponent,
        MdrRadioGroupSpecificProps {}
...
function MdrRadioGroup({
    ...
    const fullClassName =
        `MdrRadioGroup ${layout} ${disabled ? 'Disabled' : ''} ${className || ''}`.trim();
                ...
                {options.map((option) => {
                    ...
                    return (
                        <li key={option.value} className="MdrRadioGroupItem">
                            <label
                                className={`MdrRadioGroupLabel ${isDisabled ? 'Disabled' : ''}`}
                            >
                                <input
                                    type="radio"
                                    name={groupName}
                                ...
                                <span className="MdrRadioGroupText">
                                    ...
                                    {option.description && (
                                        <span className="MdrRadioGroupDescription">
                                            {option.description}
                                        </span>
                                    )}
                                </span>
