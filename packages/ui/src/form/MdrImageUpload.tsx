...
export interface MdrImageUploadProps extends MdrComponent, MdrImageUploadSpecificProps { }
...
function MdrImageUpload({
    ...
    const fullClassName = `MdrImageUpload ${disabled ? 'Disabled' : ''} ${className || ''}`.trim();
