...
export const States: Story = {
    render: () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '520px' }}>
            ...
            <MdrRegionPicker label="Error" options={regionOptions} state="Error" message="Please choose region" />
            <MdrRegionPicker label="Warning" options={regionOptions} state="Warning" message="Not serviceable" />
            <MdrRegionPicker label="Success" options={regionOptions} state="Success" message="Available" />
        </div>
    ),
};
