...
export interface MdrTimePickerProps extends MdrComponent, MdrTimePickerSpecificProps { }
...
function MdrTimePicker({
    ...
    const fullClassName = `MdrTimePicker ${size} ${state} ${disabled ? 'Disabled' : ''} ${readOnly ? 'ReadOnly' : ''} ${className || ''}`.trim();
