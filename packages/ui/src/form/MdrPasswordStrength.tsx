...
export interface MdrPasswordStrengthProps
    extends MdrComponent,
        MdrPasswordStrengthSpecificProps {}
...
function MdrPasswordStrength({
    ...
    const fullClassName =
        `MdrPasswordStrength ${size} ${disabled ? 'Disabled' : ''} ${className || ''}`.trim();
    ...
    return (
        ...
        >
            ...
            {showText && (
                <div className="MdrPasswordStrengthText">
