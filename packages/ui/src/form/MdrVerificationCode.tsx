...
export interface MdrVerificationCodeProps extends MdrComponent, MdrVerificationCodeSpecificProps { }
...
function MdrVerificationCode({
    ...
    const handlePaste = (event: React.ClipboardEvent<HTMLInputElement>) => {
        ...
        const nextChars = Array.from({ length }, (_, index) => pasteValue[index] || '');
        updateValue(nextChars);
    ...
    const fullClassName = `MdrVerificationCode ${size} ${state} ${disabled ? 'Disabled' : ''} ${className || ''}`.trim();
