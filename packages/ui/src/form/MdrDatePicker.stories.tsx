...
export const States: Story = {
    render: () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '320px' }}>
            ...
            <MdrDatePicker label="Error" value="2026-01-22" state="Error" message="Invalid date" />
            <MdrDatePicker label="Warning" value="2026-01-22" state="Warning" message="Check availability" />
            <MdrDatePicker label="Success" value="2026-01-22" state="Success" message="Looks good" />
        </div>
    ),
};
