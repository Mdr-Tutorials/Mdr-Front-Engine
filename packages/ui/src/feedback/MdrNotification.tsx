...
export interface MdrNotificationProps
    extends MdrComponent,
        MdrNotificationSpecificProps {}
        ...
        >
            <div className="MdrNotificationHeader">
                ...
                {closable && (
                    <button
                        type="button"
                        className="MdrNotificationClose"
                        onClick={onClose}
                    >
                        <X size={16} />
                    </button>
            ...
            {description && (
                <div className="MdrNotificationDescription">{description}</div>
            )}
