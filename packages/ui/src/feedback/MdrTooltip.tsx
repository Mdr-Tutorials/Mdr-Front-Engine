...
export interface MdrTooltipProps extends MdrComponent, MdrTooltipSpecificProps { }
...
function MdrTooltip({
    ...
    return (
        <span className={fullClassName} style={style as React.CSSProperties} id={id} {...dataProps}>
            {children}
