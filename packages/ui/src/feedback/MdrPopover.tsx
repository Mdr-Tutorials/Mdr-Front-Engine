...
export interface MdrPopoverProps extends MdrComponent, MdrPopoverSpecificProps { }
...
function MdrPopover({
    ...
    return (
        <span className={fullClassName} style={style as React.CSSProperties} id={id} {...dataProps} {...triggerProps}>
            {children}
            {isOpen && (
