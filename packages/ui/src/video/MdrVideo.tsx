...
function MdrVideo({
    ...
    const fullClassName = `MdrVideo ${aspectRatio.replace(':', '-')} ${className || ''}`.trim();
    ...
    return (
        <div className={fullClassName} style={containerStyle as React.CSSProperties} id={id} onClick={onClick} {...dataProps}>
